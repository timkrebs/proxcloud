...
func buildRegistry() map[routeKey]Rule {
	perms := []Permission{
		...
		{http.MethodGet, "/api/cluster", AuthenticatedRule},
		{http.MethodGet, "/api/cluster/nextid", AuthenticatedRule},
		{http.MethodGet, "/api/nodes", AuthenticatedRule},
		{http.MethodGet, "/api/nodes/{node}", AuthenticatedRule},
		{http.MethodGet, "/api/nodes/{node}/metrics", AuthenticatedRule},
		{http.MethodGet, "/api/nodes/{node}/bridges", AuthenticatedRule},
		{http.MethodGet, "/api/nodes/{node}/storages", AuthenticatedRule},
		{http.MethodGet, "/api/nodes/{node}/storages/{storage}/content", AuthenticatedRule},
		{http.MethodGet, "/api/resources", AuthenticatedRule},
		{http.MethodGet, "/api/pools", AuthenticatedRule},
		{http.MethodGet, "/api/storage", AuthenticatedRule},

		// guests (become Reader/Contributor-scoped + ownership-checked in Phase 3)
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}", AuthenticatedRule},
		{http.MethodPatch, "/api/guests/{node}/{type}/{vmid}/config", AuthenticatedRule},
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}/metrics", AuthenticatedRule},
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}/interfaces", AuthenticatedRule},
		{http.MethodPost, "/api/guests/{node}/{type}/{vmid}/resize", AuthenticatedRule},
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}/snapshots", AuthenticatedRule},
		{http.MethodPost, "/api/guests/{node}/{type}/{vmid}/snapshots", AuthenticatedRule},
		{http.MethodPost, "/api/guests/{node}/{type}/{vmid}/snapshots/{name}/rollback", AuthenticatedRule},
		{http.MethodDelete, "/api/guests/{node}/{type}/{vmid}/snapshots/{name}", AuthenticatedRule},
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}/firewall", AuthenticatedRule},
		{http.MethodPut, "/api/guests/{node}/{type}/{vmid}/firewall/options", AuthenticatedRule},
		{http.MethodGet, "/api/guests/{node}/{type}/{vmid}/acl", AuthenticatedRule},
		{http.MethodPost, "/api/guests/{node}/{type}/{vmid}/{action}", AuthenticatedRule},
		{http.MethodDelete, "/api/guests/{node}/{type}/{vmid}", AuthenticatedRule},
		{http.MethodPost, "/api/guests/{node}/{type}/{vmid}/console", AuthenticatedRule},
		{http.MethodPost, "/api/guests", AuthenticatedRule},

		// tasks / deployments / notifications / pricing
		{http.MethodGet, "/api/tasks", AuthenticatedRule},
		{http.MethodGet, "/api/tasks/{upid}", AuthenticatedRule},
		{http.MethodGet, "/api/tasks/{upid}/log", AuthenticatedRule},
		{http.MethodGet, "/api/notifications", AuthenticatedRule},
		{http.MethodPost, "/api/notifications/read", AuthenticatedRule},
		{http.MethodGet, "/api/deployments/{id}", AuthenticatedRule},
