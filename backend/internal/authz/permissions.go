...
func buildRegistry() map[routeKey]Rule {
	perms := []Permission{
		...
		{http.MethodGet, "/api/tenants/{tenantId}/projects/{projectId}/schedule", ReaderRule},
		{http.MethodPut, "/api/tenants/{tenantId}/projects/{projectId}/schedule", ContributorRule},
		{http.MethodDelete, "/api/tenants/{tenantId}/projects/{projectId}/schedule", ContributorRule},
		// TTL policy is project governance (like project quota): Owner to set,
		// Reader to view; the project TTL list is a Reader view (ADR-0020).
		{http.MethodGet, "/api/tenants/{tenantId}/projects/{projectId}/ttl-policy", ReaderRule},
		{http.MethodPut, "/api/tenants/{tenantId}/projects/{projectId}/ttl-policy", OwnerRule},
		{http.MethodGet, "/api/tenants/{tenantId}/projects/{projectId}/ttls", ReaderRule},
		...
		{http.MethodGet, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/schedule", ReaderRule},
		{http.MethodPut, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/schedule", ContributorRule},
		{http.MethodDelete, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/schedule", ContributorRule},
		{http.MethodPost, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/schedule/skip", ContributorRule},
		{http.MethodGet, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/ttl", ReaderRule},
		{http.MethodPut, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/ttl", ContributorRule},
		{http.MethodDelete, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/ttl", ContributorRule},
		{http.MethodPost, "/api/tenants/{tenantId}/guests/{node}/{type}/{vmid}/ttl/extend", ContributorRule},
